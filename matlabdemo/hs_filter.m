...
data1_1 = [w1 h1_data];
csvwrite('hs_h1.dat',data1_1);
h2_data = 20*log10((abs(h2)));
data2_2 = [w2 h2_data];
csvwrite('hs_h2.dat',data2_2);
h3_data = 20*log10((abs(h3)));
data3_3 = [w3 h3_data];
csvwrite('hs_h3.dat',data3_3);
h4_data = 20*log10((abs(h4)));
data4_4 = [w4 h4_data];
csvwrite('hs_h4.dat',data4_4);
h5_data = 20*log10((abs(h5)));
data5_5 = [w5 h5_data];
csvwrite('hs_h5.dat',data5_5);
h6_data = 20*log10((abs(h6)));
data6_6 = [w6 h6_data];
csvwrite('hs_h6.dat',data6_6);
h7_data = 20*log10((abs(h7)));
data7_7 = [w7 h7_data];
csvwrite('hs_h7.dat',data7_7);
