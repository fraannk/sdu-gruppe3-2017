...
\\
\Kenneth{Nedestående linje er lidt kringlet}
...
Således kan man teste softwaren på EMP printet, med den monterede mikrofonindgang og hovedtelefonudgang, ved at vælge \textbf{EMP} profilen.
...
\Kenneth{Nedestående linje kringlet}
...
Derfor anvendes en \textbf{Once Mode}, der bliver styret af interrupt service rutinen \textit{sample\_handler()}. Denne ISR og timingen af ADC'en vil blive uddybet i afsnittet om interrupt.
\Kenneth{Referenec til afsnittet om interrupts}
...
\Kenneth{Hvad er en kommando overførringsfunktion?}
...
\Kenneth{Som følger, følgende eller? (nedestående sætning)}
Ifølge \cite[afsnit 3.1.5.7 s. 132]{tm4c123gh6pm} er den implementeret som følger i hardware modulet \textit{hardware.c}.
