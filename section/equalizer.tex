...
\end{itemize}  
\jj{respektive frekvens områder, ville lyde bedre med fastlagte frekvens områder}
...
\jj{Hvorfor skulle den sidste være korrekt om opløsning ?, hvad er opløsningen på et analogt signal ?}