...
C24, C27 & $\SI{90}{\pico\farad}$ & Keramisk & $\pm 5\%$ & 100 \si{\volt} &  & (u)\\
C11, C14, C16, C18 & $\SI{93}{\pico\farad}$ & Keramisk & $\pm 5\%$ & 100 \si{\volt} &  & (u)\\
C29, C31 & $\SI{95}{\pico\farad}$ & Keramisk & $\pm 5\%$ & 100 \si{\volt} &  & (u)\\
C8, C9, C10, C13, C15, C17,C21, C22, C23, C26, C28, C30 & $\SI{940}{\pico\farad}$ & Keramisk & $\pm 5\%$ & 100 \si{\volt} &  & (u)\\
C2, C4, C6, C12, C20, C25 & $\SI{100}{\nano\farad}$ & Keramisk & $\pm 5\%$ & 100 \si{\volt} &  & (u)\\
C3, C7  & $\SI{318}{\nano\farad}$ & Keramisk & $\pm 5\%$ & 100 \si{\volt} &  & (u)\\
C1, C5 & $\SI{10}{\micro\farad}$ & Elektrolyt & $\pm 5\%$ & 25 \si{\volt} &  & (u)\\
C32, C33 & $\SI{1.1}{\micro\farad}$ & Polyester & $\pm 5\%$ & 100 \si{\volt} &  & (u)\\
...
C40 & $\SI{0.1}{\micro\farad}$ & Keramisk & $\pm 5\%$ & 50 \si{\volt} &  & (f)\\
C41 & $\SI{10}{\micro\farad}$ & Tantal & $\pm 5\%$ & 100 \si{\volt} &  & (f)\\
\midrule
