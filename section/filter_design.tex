...
\\
    ...
    \husk{Dennis}{skal det her stå her? og hvis ja med kilde reference?}
...
\Kenneth{Kan indgå i realiseringsdelen}
...
(fra tæller- og nævner-polynomiet af overføringsfunktionen) rykket sammen.
   ...
   \begin{figure}[h]
        ...
        \label{fig:real_diag}
    \end{figure}
\husk{Dennis}{til mig selv: er det type 1 eller 2 realisering}
