...
\husk{dennis}{fejlkilder til amplitude: skalering i bilinear transformation,dac, hvad ellers? }
...
Beviset for dette, er gjort ved at bruge de beregnede koefficienter fra MATLAB, og implementere dem direkte i DSP modulet. Dette viste de samme målinger efterfølgende, og det kan dermed konkluderes at teorien er korrekt.
