...
Den grundlæggende tilgang til windowsmetoden er baseret på at det ideelle lavpas- (ligning \ref{windows_lp}), højpas- (ligning \ref{windows_hp}), båndpas- (ligning \ref{windows_bp}), og båndstop filter (ligning \ref{windows_bs}), bestående af den følgende ikke-kausale impulsrespons på $-\infty < n < \infty$.
