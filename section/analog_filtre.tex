...
Dette DC offset betyder også at operationsforstærkerene i det analoge filter kun behøver en positiv forsyningsspænding. \\
På udgangen af rekonstruktionsfilteret sættes to kondensatore for at eliminere DC offsetet og få et arbejdspunkt ved 0V.
