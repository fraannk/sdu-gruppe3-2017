...
\begin{equation}
	 C10(R11+R12) = \dfrac{1}{w_0\cdot Q} \hspace{1cm} C11 \cdot C10 \cdot R11 \cdot R12 = \dfrac{1}{w_0^2} \nonumber
\end{equation}
...
Det kan ses at signalet fra rekonstruktions filteret indeholder højfrekvens støj. Dette kan skyldes kommunikation mellem tiva boardet og dac\footnote{Se afsnit om SPI i afsnit 4.6}. \\
