...
\Kenneth{Argument for knækfrekvens ved 22.5 kHz}
...
\Kenneth{Noget omformulering ved valg af butterworth frem for bessel}
...
\Kenneth{Argumenter for valg af størrelserne}
\begin{equation}
...
\end{figure}
\FloatBlock
\Kenneth{Figur 3.6 - Tydligere linjer}
