...
\begin{figure}[h!]
	\centering
	\includegraphics[scale=0.6]{./billeder/stage1.png}
...
\begin{figure}[h!]
	\centering
	\includegraphics[scale = 0.4]{./billeder/komp_udregn.png}
...
\begin{figure}[h!]
	\centering
	\includegraphics[scale=0.4]{./billeder/stage2.png}
	\caption{Stage 2 filter.}
...
\begin{figure}[h!]
	\centering
	\includegraphics[scale=0.4]{./billeder/stage3.png}
...
\begin{figure}[h!]
	\centering
	\includegraphics[scale = 0.3]{./billeder/pzmap.png}
