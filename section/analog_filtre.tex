...
\end{figure}
\FloatBlock
På figur \ref{fig::anfilter_recon} ses udgangssignalet fra DAC (gul), og det rekonstruerede signal (blå).
\begin{figure}[h!]
	\centering
...
Det kan ses ud fra simuleringer at udregningerne af filtret har været tilfredstillende. De parametre der blev sat i afsnit \ref{sec::anfilter_sallenpara} er blevet overholdt. Efter realisering på et PCB board kan der ydermere konstateres at lydsignalet går igennem uden de nævneværdige tab i øvre og lavere del af frekvensspektrumet. Test af filtrene kan ses i kapitel 6 og stemmer overens med teorien. 