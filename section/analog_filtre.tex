...
Dette kan realiseres ved hjælp af et anti aliasing filter (herefter AA filter). Samplingsfrekvensen af sat til $44.1\si{\kilo\hertz}$, det vil derfor være ideelt at påføre et AA filter med en betydelig dæmpning ved $22.5\si{\kilo\hertz}$.\\
...
\Kenneth{Hvilke komponenter er det? Vi skal matche dem med dem fra schematics.}
\subsection{Trin 3}
...
\begin{figure}[h]
	\centering
	\subbottom[]{%
		\includegraphics[width=0.47\textwidth]{./billeder/stage2.png}
		\label{fig::anfilter_restage2}}
	\subbottom[]{%
		\includegraphics[width=0.47\textwidth]{./billeder/stage3.png}
