...
\begin{itemize}[noitemsep]
	...
	\item Der vil blive lagt vægt på at kunne eftervise funktionaliteten af signalbehandlingen og ikke hvor god HiFi kvalitet det endelige produkt lever op til.
\end{itemize}
...
\begin{itemize}[noitemsep]
	...
	\item Equalizerens funktionalitet og effektivitet efterprøves.
\end{itemize}
